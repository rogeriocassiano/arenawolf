...
- Name: user-flow.spec.ts >> Fluxo Usuário Completo >> dashboard carrega com sidebar e KPIs
- Location: e2e/user-flow.spec.ts:26:7
...
- complementary:
  - navigation:
    ...
    - button "Sair"
- main:
  - heading "Olá, WolfUser 👋" [level=1]
  - paragraph: Bem-vindo de volta à Arena Wolf
  - text: Créditos
  - paragraph: 18h
  - text: PCs Livres
  - paragraph: 9/10
  ...
  - text: Reservas
  - paragraph: "0"
  - heading "Máquinas ao Vivo" [level=2]
  - link "Ver todas":
    - /url: /machines
    - button "Ver todas"
  - paragraph: PS5 01
  ...
  - paragraph: PC Gamer
  - text: Livre
  - heading "Próximas Reservas" [level=3]
  - paragraph: Nenhuma reserva ativa
  - link "Reservar agora":
    - /url: /machines
    - button "Reservar agora"
  - heading "Ações Rápidas" [level=3]
  - link "Reservar máquina":
    - /url: /machines
    - button "Reservar máquina"
