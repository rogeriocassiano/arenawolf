...
- Name: user-flow.spec.ts >> Fluxo Usuário Completo >> perfil do usuário mostra dados pessoais
- Location: e2e/user-flow.spec.ts:111:7
...
Locator: getByLabel(/nickname|nome/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel(/nickname|nome/i)
...
- main:
  ...
  - paragraph: Gerencie sua conta
  - text: WO
  - heading "WolfUser" [level=2]
  - text: user user@user.com Membro desde 01/06/2026 18h de créditos
  - heading "Histórico de Transações" [level=3]
  - paragraph: Solicitação de pacote "1h" — 60min (aguardando pagamento no balcão)
  - paragraph: 07/06/2026
  - text: +1h
  - paragraph: Solicitação de pacote "1h" — 60min (aguardando pagamento no balcão)
  - paragraph: 07/06/2026
  - text: +1h
  - paragraph: Compra de pacote 10h — 720min
  - paragraph: 01/06/2026
  - text: +12h
  - paragraph: Compra de pacote 3h — 240min
  - paragraph: 01/06/2026
  - text: +4h
