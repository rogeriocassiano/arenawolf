...
- Name: admin-full.spec.ts >> Painel Admin — Apps >> catálogo de apps carrega
- Location: e2e/admin-full.spec.ts:138:7
...
Locator: getByRole('tab').or(locator('[data-testid=\'app-card\']')).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('tab').or(locator('[data-testid=\'app-card\']')).first()

```

```yaml
- main:
  - heading "Launcher de Apps" [level=1]
  - paragraph: Gerencie os apps disponíveis nos PCs da lan house
  - button "Novo App"
  - button "Catálogo de Apps"
  - button "Por Máquina"
  - paragraph: 8 apps cadastrados · Aparece em todas as máquinas que o tiverem habilitado
  - img "Steam"
  - paragraph: Steam
  - text: Plataforma
  - paragraph: Plataforma de jogos Steam
  - paragraph: C:\Program Files (x86)\Steam\steam.exe
  - button "Editar"
  - button "Excluir"
  - img "Epic Games"
  - paragraph: Epic Games
  - text: Plataforma
  - paragraph: Epic Games Launcher
  - paragraph: C:\Program Files (x86)\Epic Games\Launcher\Portal\Binaries\Win32\EpicGamesLauncher.exe
  - button "Editar"
  - button "Excluir"
  - paragraph: Battle.net
  - text: Plataforma
  - paragraph: Blizzard Battle.net
  - paragraph: C:\Program Files (x86)\Battle.net\Battle.net.exe
  - button "Editar"
  - button "Excluir"
  - img "CS2"
  - paragraph: CS2
  - text: Jogo
  - paragraph: Counter-Strike 2
  - paragraph: C:\Program Files (x86)\Steam\steamapps\common\Counter-Strike Global Offensive\cs2.exe
  - button "Editar"
  - button "Excluir"
  - paragraph: Valorant
  - text: Jogo
  - paragraph: Valorant
  - paragraph: C:\Riot Games\VALORANT\live\VALORANT.exe
  - button "Editar"
  - button "Excluir"
  - paragraph: League of Legends
  - text: Jogo
  - paragraph: League of Legends
  - paragraph: C:\Riot Games\League of Legends\LeagueClient.exe
  - button "Editar"
  - button "Excluir"
  - img "Google Chrome"
  - paragraph: Google Chrome
  - text: Navegador
  - paragraph: Navegador Chrome
  - paragraph: C:\Program Files\Google\Chrome\Application\chrome.exe
  - button "Editar"
  - button "Excluir"
  - img "Discord"
  - paragraph: Discord
  - text: Utilitário
  - paragraph: Discord
  - paragraph: C:\Users\%USERNAME%\AppData\Local\Discord\Update.exe --processStart Discord.exe
  - button "Editar"
  - button "Excluir"
