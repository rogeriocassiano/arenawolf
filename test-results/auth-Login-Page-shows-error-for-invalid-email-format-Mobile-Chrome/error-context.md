...
- Name: auth.spec.ts >> Login Page >> shows error for invalid email format
...
Locator: getByText(/inválido|incorretos/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/inválido|incorretos/i)
...
- paragraph: Acesse sua conta na Arena Wolf
- text: E-mail
- textbox "E-mail":
